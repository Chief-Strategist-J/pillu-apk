...
import 'package:example/model/src/messages/system_message.dart';
...
class Chat extends StatefulWidget {
  ...
  /// See [Messages.bubbleRtlAlignment].
  ...
  /// See [Messages.emojiEnlargementBehavior].
  ...
  /// See [Messages.fileMessageBuilder].
  ...
  /// See [Messages.hideBackgroundOnEmojiMessages].
  ...
  /// See [Messages.imageMessageBuilder].
  ...
  /// List of [Messages] to render in the chat widget.
  final List<Message> messages;

  /// See [Messages.nameBuilder].
  final Widget Function(User)? nameBuilder;

  /// See [Input.onAttachmentPressed].
  final VoidCallback? onAttachmentPressed;

  /// See [Messages.onAvatarTap].
  ...
  /// See [Messages.onMessageDoubleTap].
  ...
  final Widget Function(SystemMessage)? systemMessageBuilder;

  /// See [Messages.textMessageBuilder].
  final Widget Function(
    TextMessage, {
  ...
  /// See [Messages.textMessageOptions].
  ...
  /// See [Messages.usePreviewData].
  final bool usePreviewData;

  /// See [InheritedUser.user].
  final User user;

  /// See [Messages.userAgent].
  final String? userAgent;

  /// See [ChatList.useTopSafeAreaInset].
  final bool? useTopSafeAreaInset;

  /// See [Messages.videoMessageBuilder].
  final Widget Function(VideoMessage, {required int messageWidth})? videoMessageBuilder;

  /// See [Messages.slidableMessageBuilder].
  final Widget Function(Message, Widget msgWidget)? slidableMessageBuilder;
  ...
  Widget _messageBuilder(
    ...
    if (object is DateHeader) {
      ...
      if (message is SystemMessage) {
        messageWidget = widget.systemMessageBuilder?.call(message) ?? SystemMessages(message: message.text);
      } else {
        ...
        final Widget msgWidget = Messages(
