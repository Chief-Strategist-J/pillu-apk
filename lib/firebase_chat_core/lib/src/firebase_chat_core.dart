...
import 'package:example/model/src/message.dart' as types;
import 'package:example/model/src/messages/custom_message.dart' as types;
import 'package:example/model/src/messages/file_message.dart' as types;
import 'package:example/model/src/messages/image_message.dart' as types;
import 'package:example/model/src/messages/partial_custom.dart' as types;
import 'package:example/model/src/messages/partial_file.dart' as types;
import 'package:example/model/src/messages/partial_image.dart' as types;
import 'package:example/model/src/messages/partial_text.dart' as types;
import 'package:example/model/src/messages/text_message.dart' as types;
import 'package:example/model/src/room.dart' as types;
import 'package:example/model/src/user.dart' as types;
...
class FirebaseChatCore {
  ...
  Future<types.Room> createRoom(
    ...
    final roomQuery = await getFirebaseFirestore().collection(config.roomsCollectionName).where('type', isEqualTo: types.RoomType.direct.toShortString()).where('userIds', isEqualTo: userIds).limit(1).get();
    ...
    final oldRoomQuery = await getFirebaseFirestore().collection(config.roomsCollectionName).where('type', isEqualTo: types.RoomType.direct.toShortString()).where('userIds', isEqualTo: userIds.reversed.toList()).limit(1).get();
