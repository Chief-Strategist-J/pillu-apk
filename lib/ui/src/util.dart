...
Color getUserAvatarNameColor(User user, List<Color> colors) => colors[user.id.hashCode % colors.length];
...
String getUserName(User user) => '${user.firstName ?? ''} ${user.lastName ?? ''}'.trim();
