        ...
        child: Row(
          ...
          children: <Widget>[
            widget.bubbleAlignment == BubbleRtlAlignment.left
                ...
                : const SizedBox(),
            Container(
              margin: widget.bubbleAlignment == BubbleRtlAlignment.right ? const EdgeInsets.fromLTRB(24, 24, 0, 24) : const EdgeInsets.fromLTRB(0, 24, 24, 24),
...
class TypingWidget extends StatelessWidget {
  ...
  String _multiUserTextBuilder(List<User> author) {
    if (author.isEmpty) {
      return '';
  ...
  double _getStackingWidth(List<User> author, double indicatorWidth) {
    if (author.length == 1) {
