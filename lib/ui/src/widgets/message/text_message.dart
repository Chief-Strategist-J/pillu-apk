...
import 'package:example/ui/link/src/utils.dart';
import 'package:example/ui/link/src/widgets/link_preview.dart';
...
class TextMessages extends StatelessWidget {
  /// Creates a text message widget from a [TextMessages] class.
  const TextMessages({
    super.key,
  ...
  /// Customisation options for the [TextMessages].
